    ...
    <section id='services' className='section'>
      <div className='container mx-auto'>
        <h2 className='section-title'>
          {services.title} <span className='dot' />
        </h2>
        ...
        <div className='flex flex-col items-center gap-y-12 lg:flex-row lg:justify-between lg:px-[136px]'>
          {services.skills.map((service, index) => {
            return (
              <div className='p-[30px] w-full max-w-[417px] flex flex-col text-center lg:text-left hover:bg-white hover:shadow-2xl cursor-crosshair transition-all'>
